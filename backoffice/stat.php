...
/*
    foreach ($key as $item) {
        var_dump($item);*/
         $array3[]=$p->Statistique((int)$key['catid']);
         $x++;
}
//var_dump($array);
...
window.onload = function () {
    var xd= <?php echo ($Json1); ?>;
    var encode=  <?php echo ($Json); ?>;
    var count=<?php echo($x); ?>;
    var dataPoints = [];
    for( var i = 0; i < count; i++ ) {
        dataPoints.push({ label:encode[i] ,y:Number(xd[i]) });
    }
    ...
    var chart = new CanvasJS.Chart("chartContainer",
        {    title: {
                ...
                text: "STATISTIQUE: Nombre de plats / Categorie "
            },
            data: [
                {
                    type: "column",
