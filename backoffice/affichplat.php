      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
              ...
              <form method="POST" action="affichplat.php">
                  <input type="text" id="arearech" name="search" placeholder="Taper pour rechercher ... " required>
                  <input type="submit" value="Rechercher"  class="btn btn-primary">
              </form>
              <center><h1 id="bri"><strong>List des plats</strong></h1></center>
              ...
              <div class="container">
                                  ...
                                  foreach($list as $p){
                                      ...
                                      <tr scope="row">
                                          ...
                                          <td> <a href="supp.php?id=<?php echo $p["platID"];  ?>">
                                              <input type="button" value="supprimer" class="btn btn-danger"></a></td>
                                          <td>  <a href="platEdit.php?id=<?php echo $p["platID"];  ?>">
                                              <input type="submit" value="Modifier" class="btn btn-warning"></a></td>
                  ...
                  <?php if(!empty($list)){ ?>
                      <a href="trier.php?Name=<?php echo $p["platName"]; ?>">
